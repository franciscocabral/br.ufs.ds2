...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "componentes_produtos", id: false, force: :cascade do |t|
  ...
  add_index "componentes_produtos", ["idItem"], name: "fk_Produto_has_Item_Item1_idx", using: :btree
  add_index "componentes_produtos", ["idProduto"], name: "fk_Produto_has_Item_Produto1_idx", using: :btree
  ...
  add_foreign_key "componentes_produtos", "Item", column: "idItem", primary_key: "idItem", name: "fk_Produto_has_Item_Item1", on_delete: :cascade
  add_foreign_key "componentes_produtos", "Produto", column: "idProduto", primary_key: "idProduto", name: "fk_Produto_has_Item_Produto1"
