...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should get index" do
    ...
    assert_not_nil assigns(:produto)
  end
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, nome: @produto.nome, valor: @produto.valor }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { descricao: @produto.descricao, nome: @produto.nome, valor: @produto.valor }
    assert_redirected_to produto_path(assigns(:produto))
  end
